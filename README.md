...
| layers      | [MapLayers](docs/properties)        | Opcional    | Define as camadas base e camadas customizadas.                             |
| options     | [MapOptionsConfig](docs/properties) | Opcional    | Define as configurações do mapa, menu de camadas e ferramentas de desenho. |
